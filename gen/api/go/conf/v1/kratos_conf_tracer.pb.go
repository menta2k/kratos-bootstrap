...
type Tracer struct {
	...
	Endpoint string  `protobuf:"bytes,2,opt,name=endpoint,proto3" json:"endpoint,omitempty"` // port
...
var file_conf_v1_kratos_conf_tracer_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x89, 0x01, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x42, 0x15,
