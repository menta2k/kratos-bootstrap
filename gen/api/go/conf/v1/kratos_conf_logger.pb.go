...
type Logger_Logrus struct {
	...
	DisableColors    bool   `protobuf:"varint,4,opt,name=disable_colors,json=disableColors,proto3" json:"disable_colors,omitempty"`          // Disable color output
	DisableTimestamp bool   `protobuf:"varint,5,opt,name=disable_timestamp,json=disableTimestamp,proto3" json:"disable_timestamp,omitempty"` // Tisable timstamp
}
...
type Logger_Fluent struct {
	...
	Endpoint string `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"` // endpoint address
}
...
var file_conf_v1_kratos_conf_logger_proto_rawDesc = []byte{
	...
	0x74, 0x42, 0x89, 0x01, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x42, 0x15,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x32, 0x6b, 0x2f, 0x6b, 0x72, 0x61, 0x74,
	0x6f, 0x73, 0x2d, 0x62, 0x6f, 0x6f, 0x74, 0x73, 0x74, 0x72, 0x61, 0x70, 0x2f, 0x67, 0x65, 0x6e,
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x2f, 0x76, 0x31, 0xa2,
